...
(t::AffineTransform)(x::NumUnion) = muladd(x, t.scale, t.offset)
...
unittype(::Type{<:QuantUnion{<:Any,U}}) where U = U
dimtype(::Type{<:QuantUnion{<:Any,U}}) where U = dimtype(U)
dimvaltype(::Type{<:QuantUnion{<:Any,U}}) where U = dimvaltype(U)
